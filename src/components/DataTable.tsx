...
const columns: GridColDef[] = [
    ...
    { field: 'mimetype', headerName: 'File Extension', flex: 1 },
    { field: 'upper_cap', headerName: 'Top Writing', flex: 1 },
    { field: 'lower_cap', headerName: 'Bottom Writing', flex: 1 },
  ];
      ...
      <>
        ...
        <div className="flex flex-row">
          <div>
            <Button
              ...
              onClick={() => handleOpen()}>New Image</Button>
          </div>
          <Button
            onClick={handleOpen}
        ...
        <div className={ open ? "hidden" : "container mx-10 my-5 flex flex-col"}
          style={{ height: 400, width: '100%' }}>
            <h2 className="p-3 bg-slate-300 my-2 rounded">Meme Me Up</h2>
            <DataGrid 
            rows={imageData} 
            columns={columns} 
